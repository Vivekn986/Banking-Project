...
#Data Dictionary
#Each row represents characteristic of a single customer . Many categorical data has been coded to mask the data, you don't need to worry about their exact meaning 
