...
Problem Statement- we have given two datasets bank-full_train.csv and bank-full_test.csv sets.we use bank-full train data to build the predictive model for a variable 'y' and bank-full test data contains all other factors except y.need to predict that using the model that you developed.
